#ifndef SiPhase2DigitizerAlgorithm_h
#define SiPhase2DigitizerAlgorithm_h
...
class SiPhase2DigitizerAlgorithm  {
 public:
  SiPhase2DigitizerAlgorithm(const edm::ParameterSet& conf, CLHEP::HepRandomEngine&);
...
=======
  //    const float Dist300;  //=0.0300  // Define 300microns for normalization 
>>>>>>> d97f19bbb3f9fcd39191d2663fb204a50a27ecdb
